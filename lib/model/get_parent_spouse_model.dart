...
GetParentAndSiblingModel getParentAndSiblingModelFromJson(String str) => GetParentAndSiblingModel.fromJson(json.decode(str));

String getParentAndSiblingModelToJson(GetParentAndSiblingModel data) => json.encode(data.toJson());
...
class GetParentAndSiblingModel {
    ...
    factory GetParentAndSiblingModel.fromJson(Map<String, dynamic> json) => GetParentAndSiblingModel(
        marriageId: json["marriageId"],
        marriageStatus: json["marriageStatus"],
        parent1: Parent1.fromJson(json["parent1"]),
        parent2: Parent1.fromJson(json["parent2"]),
        siblings: List<Parent1>.from(json["siblings"].map((x) => Parent1.fromJson(x))),
    );
